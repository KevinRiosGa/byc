function cargarMarcasPorTipo(tipoId, $selectMarca, marcaSeleccionada) {
    ...
    $.get('/maq_equipo/ajax/marcas_por_tipo/', { tipo_id: tipoId }, function(data) {
        $selectMarca.empty();
...
$(document).ready(function() {
    ...
    $('#form-add-modelo').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
            url: '/maq_equipo/modelo_equipo/crear/',
            type: 'POST',
            data: $(this).serialize(),
    ...
    $('#form-edit-modelo').on('submit', function(e) {
        ...
        $.ajax({
            url: '/maq_equipo/modelo_equipo/' + id + '/editar/',
            type: 'POST',
            data: {
    ...
    $('#confirm-delete-modelo').click(function() {
        ...
        $.ajax({
            url: '/maq_equipo/modelo_equipo/' + id + '/eliminar/',
            type: 'POST',
            data: {
